...
<div class="container">
    ...
    <table class="table table-striped table-hover" >
        ...
        <form method="post" action="{{route('navs.update',[$nav])}}" enctype="multipart/form-data">
            <h4>菜单名</h4>
            <input type="text" value="{{$nav->name}}" name="name" class="form-control" placeholder="请输入菜单名字">
            ...
            <div class="form-group field-menu-url">
                ...
                <input type="text" value="{{$nav->url}}" name="url" class="form-control" placeholder="请输入路由地址">

    ...
    <div class="navbar">
        ...
        <div class="container">
            ...
            <table class="table table-striped table-hover" >
                ...
                <form method="post"  action="{{route('save.password',[$user])}}" enctype="multipart/form-data">
                    <h4>管理员名字</h4>
                    <input type="text" value="{{$user->name}}" name="name" class="form-control" disabled="ture" placeholder="请输入管理员名字">
                    <h4>请输入旧密码</h4>
                    <input type="password" value="" name="jiu" class="form-control" placeholder="请输入管理员名字">
                    <h4>请输入新密码</h4>

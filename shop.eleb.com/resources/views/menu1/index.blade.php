            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <form method="post" action="{{route('menus.keyword')}}" class="navbar-form navbar-left">
                            <div class="form-group">
                               <input type="text" name="price1" style="width: 35px;height:25px" /><span>---</span>
                                <input type="text" name="price2" style="width: 35px;height:25px" />
                                {{csrf_field()}} <input type="text" name="keyword" class="form-control" placeholder="请输入关键词">
                            </div>
        ...
        <table class="table table-striped table-hover" >
            ...
            @foreach($rows as $row)
                ...
                <tr>
                    ...
                    <td><form style="display: inline" method="post" action="{{route('menus.destroy',[$row])}}">
                            {{ csrf_field() }}
                            {{ method_field('delete') }}
                            <button type="submit" class="btn btn-danger">删除</button>
                        </form>
                        <a href="{{route('menus.edit',[$row])}}" class="btn btn-info">编辑</a></td>
